...
stage_themes = {
    ...
    2: {"name": "Statue", "color": "#FFD700"},  # Renamed to "Statue"
        ...
        with stage_container:
            ...
            if session_id:
                ...
                with session_container:
                    ...
                    st.markdown(
                        f"<div style='border: 1px solid #000; padding: 10px; border-radius: 5px;'>",
                        unsafe_allow_html=True,
                    )
                    # Title and subtitle
                    st.markdown(
                        f"<h4 style='margin-bottom: 5px;'>{session_name}</h4>",
                        unsafe_allow_html=True,
                    )
                    st.markdown(
                        f"<p style='margin-top: 0px; color: #555;'>{session_id}</p>",
                        unsafe_allow_html=True,
                    )
